...
st.title("Anonimizador bilingüe")
...
st.markdown("""### Método de anonimización:
...
text_input = st.text_area("Escribe el texto que deseas anonimizar", value="Hola, me llamo María Salima y vivo en la Calle de las Rosas 123. Tel: 617753689.")
